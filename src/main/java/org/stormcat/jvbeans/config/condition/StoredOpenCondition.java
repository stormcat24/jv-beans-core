 ...
 *
 */
public class StoredOpenCondition <T extends JvBindingDto> extends OpenCondition <T> {
     ...
     * @param type バインディング型
     */
    public StoredOpenCondition(DataSpec dataSpec, RecordTypeId recordTypeId, Class<T> type) {
