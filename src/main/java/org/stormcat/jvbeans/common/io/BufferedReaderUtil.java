...
public class BufferedReaderUtil {
    ...
    protected BufferedReaderUtil() {
        
    }
    
    public static BufferedReader getReader(String filePath, Charset charset) {
        return getReader(new File(filePath), charset);
    }
    
    public static BufferedReader getReader(File file, Charset charset) {
        return new BufferedReader(InputStreamReaderUtil.getReader(FileInputStreamUtil.getStream(file), charset));
    }
}
